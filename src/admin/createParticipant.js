...
// Usage: node src/admin/createParticipant.js db.sqlite3 participant-name password organizer-true-false section-name
//
...
const organizer = process.argv[5] === 'true' ? true : false;
