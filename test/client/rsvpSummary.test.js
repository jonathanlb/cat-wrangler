...
describe('RSVP Summary Component', () => {
  test('Renders', () => {
    const dateTimes = {
      11: { yyyymmdd: '2018-12-01', hhmm: '10:00', duration: '30m', event: 39 },
      12: { yyyymmdd: '2018-11-30', hhmm: '10:00', duration: '30m', event: 39 },
      13: { yyyymmdd: '2018-12-02', hhmm: '10:00', duration: '30m', event: 39 }
    };
    const summary = {
      "11": { "-1": 1, "0": 1, "1": 2 },
      "12": { "1": 1 },
